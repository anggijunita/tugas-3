...
<header id="header" class="fixed-top bg-dark">
  ...
  <section id="hero" class="d-flex align-items-center justify-content-center">
    <div class="container position-relative">
      ...
      <h2>Selamat Datang di web Jual Mobil Kami</h2>
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <h4>Harga</h4>
                <p>Rp 504,9 Juta - Rp 704,5 Juta</p>
              </div>
              <div class="col-md-6">
                <i class="bx bx-cube-alt"></i>
                <h4>Spesifikasi</h4>
                <p>Tersedia 4 tipe All New Rush. Harga mobil SUV Toyota tersebut dibanderol mulai 244 Jutaan untuk tipe termurah yang mengusung transmisi manual. Kemudian untuk jantung pacunya ditenagai mesin 4 Silinder DOHC Dual VVT-i berkapasitas 1.496cc yang sanggup memuntahkan tenaga sebesar 104 PS pada 6.000 rpm dan torsi 13.9 kg.m pada 4.200 rpm.</p>
              </div>
            </div>
          </div>
        </div>
